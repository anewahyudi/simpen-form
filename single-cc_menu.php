...
if (isset($_POST['submitted'])) {
    ...
    if (trim($_POST['checking']) !== '') {
        ...
        if (trim($_POST['payment']) === '') {
            $paymentError = 'You forgot to enter Payment Methode.';
            $hasError = true;
        } else {
        ...
        if (!isset($hasError)) {
            ...
            $subject = 'Catering Culture Order from ' . $name;
            ...
            $body.='<table><tr>';
            $body.='<td><h3>'. get_the_title().'</h3></td><td></td>';
            $body.='</tr></table>';
            $body.='<table width="100%" style="padding:20px; background:#fff"> <tbody bgcolor="#fffff" style="padding:20px border:1px solid #dedede">';
            $body.='<tr><td style="font-weight:bold;" ><h3>Additional Side Order</h3> </td><td style="font-weight:bold;"><h3>Quantity</h3>
           </td><td style="font-weight:bold; "><h3>Amount</h3> </td></tr>';
            //satay otah=====
            $body.='<tr><td colspan="3"><h3>Satay Otah</h3></td></tr>';
            ...
            $total_satay_otah=$total_chicken_satay+$total_assorted_mixture_satay+$total_spicy_fish_otah+$total_spicy_fish_otah_small+$total_lontong;
            $body.='<tr><td colspan="2"></td><td><b>$'.$total_satay_otah.'</b></td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';

            //Chicken=====
            $body.='<tr><td colspan="3"><h3>Chicken</h3></td></tr>';
            $body.='<tr><td> Thai Hot & Spicy Drumlets 25pcs $25.00 ($26.75 w/GST)</td> <td>' . $thai_hot . '</td> <td> $ ' . $total_thai_hot . '</td></tr>';
            $body.='<tr><td> Curry Chicken with Potatoes 12pax $35.00 ($37.45 w/GST)</td> <td>' . $curry_chicken . '</td> <td> $ ' . $total_curry_chicken . '</td></tr>';
            $body.='<tr><td> Sweet & Sour Chicken with Trio Capsicums 12pax $30.00 ($32.10 w/GST)</td> <td>' . $sweet_sour_chicken . '</td> <td> $ ' . $total_sweet_sour_chicken . '</td></tr>';
            $body.='<tr><td> Grilled Yakitori Chicken on Skewer 25pcs $30.00 ($32.10 w/GST)</td> <td>' . $grilled_yakitori . '</td> <td> $ ' . $total_grilled_yakitori . '</td></tr>';
            $body.='<tr><td> Golden Seaweed Chicken 30pcs $26.00 ($27.82 w/GST) </td> <td>' . $golden_seaweed . '</td> <td> $ ' . $total_golden_seaweed . '</td></tr>';
            $body.='<tr><td> Grilled Black Pepper Chicken Drumlets 25pcs $25.00 ($26.75 w/GST) </td> <td>' . $grilled_black_Pepper . '</td> <td> $ ' . $total_grilled_black_Pepper . '</td></tr>';
            $body.='<tr><td> Hickory BBQ Drumlets 25pcs $25.00 ($26.75 w/GST)</td> <td>' . $hickory_bbq . '</td> <td> $ ' . $total_hickory_bbq . '</td></tr>';
            $body.='<tr><td> Grilled Teriyaki Drumlets 25pcs $25.00 ($26.75 w/GST)</td> <td>' . $grilled_teriyaki . '</td> <td> $ ' . $total_grilled_teriyaki . '</td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';
            $total_chiken=$total_thai_hot+$total_curry_chicken+$total_sweet_sour_chicken+$total_grilled_yakitori+$total_golden_seaweed+$total_grilled_black_Pepper+$total_hickory_bbq+$total_grilled_teriyaki;
            $body.='<tr><td colspan="2"></td><td><b>$'.$total_chiken.'</b></td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';

            //Noodle=====
            $body.='<tr><td colspan="3"><h3>Noodle</h3></td></tr>';
            $body.='<tr><td> Nonya Dry Mee Siam with Condiments 12pax $25.00 ($26.75 w/GST)</td> <td>' . $nonya_dry_mee_siam . '</td> <td> $ ' . $total_nonya_dry_mee_siam . '</td></tr>';
            $body.='<tr><td> Seafood Sin Chow Fried Bee Hoon 12pax $25.00 ($26.75 w/GST)</td> <td>' . $seafood_sin_chow . '</td> <td> $ ' . $total_seafood_sin_chow . '</td></tr>';
            $body.='<tr><td> Seafood Mee Goreng 12pax $25.00 ($26.75 w/GST)</td> <td>' . $seafood_mee_goreng . '</td> <td> $ ' . $total_seafood_mee_goreng . '</td></tr>';
            $body.='<tr><td> Ee Fu Mee with Mushroom 12pax $25.00 ($26.75 w/GST) </td> <td>' . $ee_fu_mee . '</td> <td> $ ' . $total_ee_fu_mee . '</td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';
            $total_noodle=$total_nonya_dry_mee_siam+$total_seafood_sin_chow+$total_seafood_mee_goreng+$total_ee_fu_mee;
            $body.='<tr><td colspan="2"></td><td><b>$'.$total_noodle.'</b></td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';
            //Snacks=====
            $body.='<tr><td colspan="3"><h3>Snacks</h3></td></tr>';
            $body.='<tr><td> Egg Chunk & Tuna Onions Finger Sandwiches (with Zucchini) 30pcs $20.00 ($21.40 w/GST) </td> <td>' . $egg_chunk . '</td> <td> $ ' . $total_egg_chunk . '</td></tr>';
            $body.='<tr><td> Vegetables Spring Rolls 25pcs $20.00 ($21.40 w/GST) </td> <td>' . $vegetable_spring . '</td> <td> $ ' . $total_vegetable_spring . '</td></tr>';
            $body.='<tr><td> Shell Curry Puffs 20pcs $20.00 ($21.40 w/GST)</td> <td>' . $shell_curry_puffs . '</td> <td> $ ' . $total_shell_curry_puffs . '</td></tr>';
            $body.='<tr><td> Samosa (Medium) 20pcs $20.00 ($21.40 w/GST)</td> <td>' . $samosa . '</td> <td> $ ' . $total_samosa . '</td></tr>';
            $body.='<tr><td> Chicken Nuggets 1kg $20.00 ($21.40 w/GST) </td> <td>' . $chicken_nuggets . '</td> <td> $ ' . $total_chicken_nuggets . '</td></tr>';
            $body.='<tr><td> Golden Fish Balls 1kg $18.00 ($19.26 w/GST) </td> <td>' . $golden_fish_balls . '</td> <td> $ ' . $total_golden_fish_balls . '</td></tr>';
            $body.='<tr><td> Golden Cuttlefish Balls 1kg $18.00 ($19.26 w/GST) </td> <td>' . $golden_cuttlefish . '</td> <td> $ ' . $total_golden_cuttlefish . '</td></tr>';
            $body.='<tr><td> Golden Prawn Balls 1kg $18.00 ($19.26 w/GST) </td> <td>' . $golden_prawn_balls . '</td> <td> $ ' . $total_golden_prawn_balls . '</td></tr>';
            $body.='<tr><td> Prawn Wantons with Mayonnaise 25pcs $20.00 ($21.40 w/GST) </td> <td>' . $prawn_wantons . '</td> <td> $ ' . $total_prawn_wantons . '</td></tr>';
            $body.='<tr><td> Chicken Ngoh Hiong (Wu Xiang) with Chef Sauce 30pcs $20.00 ($21.40 w/GST) </td> <td>' . $chicken_ngoh_hiong . '</td> <td> $ ' . $total_chicken_ngoh_hiong . '</td></tr>';
            $body.='<tr><td> Mini Chicken Pies (Chicken) 20pcs $25.00 ($26.75 w/GST) </td> <td>' . $mini_chicken_pies . '</td> <td> $ ' . $total_mini_chicken_pies . '</td></tr>';
            $body.='<tr><td> Baked Quice Lorraine 20pcs $25.00 ($26.75 w/GST)</td> <td>' . $baked_quice_lorraine . '</td> <td> $ ' . $total_baked_quice_lorraine . '</td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';
            $total_snacks=$total_egg_chunk+$total_vegetable_spring+$total_shell_curry_puffs+$total_samosa+$total_chicken_nuggets+$total_golden_fish_balls+$total_golden_cuttlefish+$total_golden_prawn_balls+$total_prawn_wantons+$total_chicken_ngoh_hiong+$total_mini_chicken_pies+$total_baked_quice_lorraine;
            $body.='<tr><td colspan="2"></td><td><b>$'.$total_snacks.'</b></td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';
            //Salad=====
            $body.='<tr><td colspan="3"><h3>Salad</h3></td></tr>';
            $body.='<tr><td> Classis Ceaser Salad 12pax $25.00 ($26.75 w/GST)</td> <td>' . $classis_ceaser . '</td> <td> $ ' . $total_classis_ceaser . '</td></tr>';
            $body.='<tr><td> Potatoes Salad with Turkey Bacons 12pax $25.00 ($26.75 w/GST)</td> <td>' . $potatoes_salad . '</td> <td> $ ' . $total_potatoes_salad . '</td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';
            $total_salad=$total_classis_ceaser+$total_potatoes_salad;
            $body.='<tr><td colspan="2"></td><td><b>$'.$total_salad.'</b></td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';
            //Sweet Pastries=====
            $body.='<tr><td colspan="3"><h3>Sweet Pastries</h3></td></tr>';
            $body.='<tr><td> Chocolate & Banana Muffins 25pcs $20.00 ($21.40 w/GST)</td> <td>' . $chocolate_banana_muffins . '</td> <td> $ ' . $total_chocolate_banana_muffins . '</td></tr>';
            $body.='<tr><td> Deluxe Fruit Tarts 18pcs $20.00 ($21.40 w/GST)</td> <td>' . $deluxe_fruit_tarts . '</td> <td> $ ' . $total_deluxe_fruit_tarts . '</td></tr>';
            $body.='<tr><td> Assorted Swiss Rolls (Chocolate & Vanilla Lemonade) 25pcs $20.00 ($21.40 w/GST)</td> <td>' . $assorted_swiss_rolls . '</td> <td> $ ' . $total_assorted_swiss_rolls . '</td></tr>';
            $body.='<tr><td> Assorted Mini French Danish (Strawberry, Chocolate & Raisin) 20pcs $20.00 ($21.40 w/GST)</td> <td>' . $assorted_mini_french_fanish . '</td> <td> $ ' . $total_assorted_mini_french_fanish . '</td></tr>';
            $body.='<tr><td> Chocolate Doughnuts 20pcs $20.00 ($21.40 w/GST)</td> <td>' . $chocolate_doughnuts . '</td> <td> $ ' . $total_chocolate_doughnuts . '</td></tr>';
            $body.='<tr><td> Chocolate Éclairs 25pcs $20.00 ($21.40 w/GST)</td> <td>' . $chocolate_eclairs . '</td> <td> $ ' . $total_chocolate_eclairs . '</td></tr>';
            $body.='<tr><td> Apple Strudels 20pcs $20.00 ($21.40 w/GST) </td> <td>' . $apple_strudels . '</td> <td> $ ' . $total_apple_strudels . '</td></tr>';
            $body.='<tr><td> Chocolate Brownies 20pcs $20.00 ($21.40 w/GST) </td> <td>' . $chocolate_brownies . '</td> <td> $ ' . $total_chocolate_brownies . '</td></tr>';
            $body.='<tr><td> Cream Puffs 30pcs $20.00 ($21.40 w/GST) </td> <td>' . $cream_puffs . '</td> <td> $ ' . $total_cream_puffs . '</td></tr>';
            $body.='<tr><td> Home Baked Egg Tarts 20pcs $20.00 ($21.40 w/GST) </td> <td>' . $home_baked_egg_tarts . '</td> <td> $ ' . $total_home_baked_egg_tarts . '</td></tr>';
            $body.='<tr><td> Deluxe Fresh Fruits Platter 15pax $35.00 ($37.45 w/GST) </td> <td>' . $deluxe_fresh_fruits . '</td> <td> $ ' . $total_deluxe_fresh_fruits . '</td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';
            $total_sweet_pastries=$total_chocolate_banana_muffins+$total_deluxe_fruit_tarts+$total_assorted_swiss_rolls+$total_assorted_mini_french_fanish+$total_chocolate_doughnuts+$total_chocolate_eclairs+$total_apple_strudels+$total_chocolate_brownies+$total_cream_puffs+$total_home_baked_egg_tarts+$total_deluxe_fresh_fruits;
            $body.='<tr><td colspan="2"></td><td><b>$'.$total_sweet_pastries.'</b></td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';

            //Beverage (Ambient Temperature)=====
            $body.='<tr><td colspan="3"><h3>Beverage (Ambient Temperature)</h3></td></tr>';
            $body.='<tr><td> Pokka Packet Drinks (Green Tea, Lemon Tea, Apple Tea & etc…) 250ml $1.00 ($1.07 w/GST) </td> <td>' . $pokka_packet_drinks . '</td> <td> $ ' . $total_pokka_packet_drinks . '</td></tr>';
            $body.='<tr><td> 7 Up/ Coke/ Green Tea 330ml $1.50 ($1.61 w/GST)</td> <td>' . $coke . '</td> <td> $ ' . $total_coke . '</td></tr>';
            $body.='<tr><td> Mineral Water Bottles 500ml $1.00 ($1.07 w/GST)</td> <td>' . $mineral_water_bottles . '</td> <td> $ ' . $total_mineral_water_bottles . '</td></tr>';
            $body.='<tr><td> Mineral Water Cup $0.60 ($0.64 w/GST)</td> <td>' . $mineral_water_cup . '</td> <td> $ ' . $total_mineral_water_cup . '</td></tr>';
            $body.='<tr><td> Ice Cubes in Foam Boxes 8kg $20.00 ($21.40 w/GST)</td> <td>' . $ice_cubes . '</td> <td> $ ' . $total_ice_cubes . '</td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';
            $total_beverage=$total_pokka_packet_drinks+$total_coke+$total_mineral_water_bottles+$total_mineral_water_cup+$total_ice_cubes;
            $body.='<tr><td colspan="2"></td><td><b>$'.$total_beverage.'</b></td></tr>';
            $body.='<tr><td colspan="3"><hr></td></tr>';           
            $total_side_order=$total_satay_otah+$total_chiken+$total_noodle+$total_snacks+$total_salad+$total_sweet_pastries+$total_beverage;
            $body.='<tr><td colspan="2"><h3>Total </h3></td><td><h3>$'.$total_side_order.'</h3></td></tr>'; 
            $body.='<tr><td colspan="2"><h3> '. get_the_title().'</h3></td><td><h3> $'. $menu_price.'</h3></td></tr>';
            $gt=$total_side_order+$menu_price;
            $body.='<tr><td colspan="2"><h3>Grand Total </h3></td><td><h3> $'. $gt.'</h3></td></tr>';
            $body.='</tbody></table>';

            //PERSONAL INFO======================

            $body.='<table width="100%" style="padding:20px; background:#fff"><tbody>';
            $body.='<tr><td colspan="2"><h3>Personal Info</h3></td></tr>';
            $body.='<tr><td>Name</td> <td>' . $pre . '.' . $name . '</td></tr>';
            $body.='<tr><td>Company</td> <td>' . $company . '</td></tr>';
            $body.='<tr><td>Contact Person</td> <td>' . $contact_person . '</td></tr>';
            $body.='<tr><td>Telephone</td> <td>' . $telephone . '</td></tr>';
            $body.='<tr><td>Mobile</td> <td>' . $mobile . '</td></tr>';
            $body.='<tr><td>Fax</td> <td>' . $fax . '</td></tr>';
            $body.='<tr><td>Billing Address</td> <td>' . $billing_address . '</td></tr>';
            $body.='<tr><td>Postal Code</td> <td>' . $postal_code . '</td></tr>';
            $body.='<tr><td>Delivery Address/Venue</td> <td>' . $delivery_address . '</td></tr>';
            $body.='<tr><td> your buffet location on a lift level</td> <td>' . $floor . '</td></tr>';
            $body.='<tr><td> Delivery Date</td> <td>' . $delivery_date . '</td></tr>';
            $body.='<tr><td> Ready By</td> <td>' . $ready_by . '</td></tr>';
            $body.='<tr><td> No Of Guest</td> <td>' . $guest . '</td></tr>';
            $body.='<tr><td> Special Instructions</td> <td>' . $special_instructions . '</td></tr>';
            $body.='</tbody></table>';

            //Payment Methode======================
            $body.='<table width="100%" style="padding:20px; background:#fff"><tbody>';
            $body.='<tr><td><h3>Mode of Payment</h3></td> <td>' . $payment . '</td></tr>';
            $body.='<tr><td></td> <td>' . $ministry . '</td></tr>';
            $body.='<tr><td></td> <td>' . $business_unit . '</td></tr>';
            $body.='<tr><td></td> <td>' . $sub_business_unit . '</td></tr>';

            //=========================================
            $body.='<tr><td></td> <td>' . $teachers_name . '</td></tr>';
            $body.='<tr><td></td> <td>' . $teachers_email . '</td></tr>';
            $body.='<tr><td></td> <td>' . $teachers_hp . '</td></tr>';
            $body.='<tr><td></td> <td>' . $student_name . '</td></tr>';
            $body.='<tr><td></td> <td>' . $student_email . '</td></tr>';
            $body.='<tr><td></td> <td>' . $student_hp . '</td></tr>';

            $body.='</tbody></table>';

            $body.='</body></html>';

            $headers = 'From: Catering Culture <' . $emailTo . '>' . "\r\n" . 'Reply-To: ' . $email;
                    ...
                    <?php while (have_posts()) : the_post(); ?>
                        ...
                        <?php if (isset($hasError) || isset($captchaError)) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" id="copy" name="billing_address_option" value="yes"> Yes |
                                <input type="radio" id="reset" name="billing_address_opdion" value="no"> No
                            </div>
